                ...
                >
                  <td>
                    <span className="chunk-type-icon" aria-hidden="true" title={isContainer ? `Container (${ch.childCount ?? 0} sub-chunks)` : 'Leaf chunk'}>
                      {isContainer ? (
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
                      ) : (
